...
const TextSlider = () => {
    ...
    return (
        ...
        <div class="flex justify-center items-center h-screen w-screen z-50" style={{ backgroundImage: `url(${backgroundimage})`, backgroundSize: 'contain' }}>
       <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-tr from-gray-900 to-gray-700 opacity-90 z-1"></div>   <div className='z-0'> <h1 className="text-6xl font-black text-gray-50 italic text-center py-5 z-0">MAZUGPT <span className='text-yellow-500'>1.0</span></h1>   
             <div className="grid grid-cols-3 z-50 gap-8 p-2 shadow-2xl rounded-2xl border-b-8 border-2 border-gray-700 bg-gray-800 " >
                ...
                <div className="bg-gray-800 p-4   border-2 border-gray-600 rounded-2xl  ">
                    <textarea
                        value={textState.text1}
                        onChange={(e) => setTextState((prevState) => ({ ...prevState, text1: e.target.value }))}
                    ...
                    <textarea
                        ...
                        cols="30"
                        disabled={currentStep !== 1}
                        className={`w-full p-2 mt-2 border border-gray-500 rounded ${currentStep !== 1 ? 'bg-gray-600' : ''}`}
                    />
                    <br />
                    {currentStep === 1 && (
                        <div className="mt-4">
                            <button
                                onClick={handleTranslate1}
                ...
                <div className="bg-gray-800 p-4 border-2 border-gray-600 rounded-2xl">
                    <textarea
                        ...
                        onChange={(e) => setTextState((prevState) => ({ ...prevState, text3: e.target.value }))}
                        placeholder="Type or paste text here"
                        rows="5"
                        cols="30"
                    ...
                    <textarea
                        ...
                        cols="30"
                        disabled={currentStep !== 2}
                        className={`w-full p-2 mt-2 border border-gray-500 rounded ${currentStep !== 2 ? 'bg-gray-600' : ''}`}
                    />
                    <br />
                    {currentStep === 2 && (
                        <div className="mt-4">
                ...
                <div className="bg-gray-800 p-4 border-2 border-gray-600 rounded-2xl">
                    <textarea
                        ...
                        className={`w-full p-2 border border-gray-500 rounded ${currentStep !== 3 ? 'bg-gray-600' : ''}`}
                    />
                    <br />
                    {currentStep === 3 && (
